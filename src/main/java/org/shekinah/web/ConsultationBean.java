...
public class ConsultationBean implements Serializable {
    ...
    private List<LaboEntity> availableLaboList;
    ...
    // Get a List of all labo
    public List<LaboEntity> getAvailableLabo() {
        if (this.availableLaboList == null) {
            this.availableLaboList = laboService.findAvailableLabo(this.consultation);
        }
        return this.availableLaboList;
    }
    
    // Update labo of the current consultation
    public void updateLabo(LaboEntity labo) {
        this.consultation.setLabo(labo);
        // Maybe we just created and assigned a new labo. So reset the availableLaboList.
        availableLaboList = null;
    }
